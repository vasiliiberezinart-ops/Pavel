...
const I18N = {
  ru: {
    ...
    m_director: '"РЕЖИССЁРЫ"',
    m_song: '"ПЕСНЯ"',
    m_dur: '"ДЛИНА"',
    m_format: '"ФОРМАТ"',
    m_budget: '"БЮДЖЕТ"',
    m_loc: '"МЕСТО"',
    loc_v: "ЗАБРОШЕННЫЙ ДК",
    loc_desc: "Действие — в заброшенном Дворце культуры. Колонны, балкон с балюстрадой, лепные розетки. Зелёные стены, осколки стекла на деревянном полу. Лагерь — не палатки UNHCR, а пустой пафос бывшего дома власти.",
    f01_l: "«— ИНСТРУМЕНТАЛ —»",
    f01_p: "Колонный зал заброшенного ДК. Свет из высоких окон, пыль в воздухе. Клоун стоит спиной у балюстрады балкона. Тишина. Откуда-то — первый удар.",
    ...
    f02_p: "Клоун идёт под колоннадой, стопка бумаг — анкет, протоколов — в руках. Мимо стен с граффити, мимо двух пустых деревянных кресел в центре зала. Бумаги выпадают, никто не подбирает.",
    f03_l: "«СВОБОДА И НИКЧЕМНОСТЬ / СВОБОДА И НЕОПРЕКАЕМОСТЬ / СВОБОДА И ОБРЕЧЕННОСТЬ»",
    f03_p: "Широкий план: клоун — маленький под высокими сводами зала с лепниной. Замедление. Холодный свет из окон. Слово «свобода» — как пустая жестянка на пустом полу.",
    ...
    f04_p: "Делегация «представителей» в плохих костюмах поднимается на балкон ДК. Машут бумагой, ставят печать. Клоун внизу. За балюстрадой — серый дневной свет. Зелёные стены в трещинах.",
    f05_l: "«ПОРОЙ НАВАЛИВАЕТ В ТОСКА / ЧТО ОДНИМ ПРЕДАТЕЛЬ, ДРУГИМ МАСКАЛЬ / ДУМАЕШЬ, ЗАТО ЭТО НЕ МАСКА / ЗАТО ЭТО НЕ МАСКА»",
    f05_p: "Клоун перед осколком стекла на полу зелёного зала. Смотрится в осколок. Отражение запаздывает. Поднимает руку — отражение поднимает. Снимает с лица — отражение не снимает.",
    f06_l: "«СВОБОДА И НИКЧЕМНОСТЬ…» — НА ВОКАЛИЗЕ",
    f06_p: "Быстрый монтаж лиц — массовка в фойе ДК, все чуть не в фокусе. Клоун в центре под лепниной, статичен. Бумаги, осколки, обрывки занавесок. Кто-то моет руки в тазу у колонны.",
    f07_l: "«— ЗАТИХАНИЕ —»",
    f07_p: "Клоун снимает с лица — или надевает. Не показываем что. ДК пуст. Только полоса света от высокого окна на деревянном полу и один осколок зеркала. Стоп-кадр.",
    prod_need_h: '"НУЖНО"',
    prod_team_h: '"КОМАНДА"',
    need_1: "Локация — заброшенный ДК (есть)",
    ...
    team_1: "Режиссёры — Василий Берёзин, Даниил Голованов",
  ...
  en: {
    ...
    m_budget: '"BUDGET"',
    m_loc: '"LOCATION"',
    loc_v: "ABANDONED PALACE",
    loc_desc: "The action takes place in an abandoned Soviet Palace of Culture. Columns, balcony balustrade, plaster rosettes. Green walls, broken glass on the wooden floor. The camp is not a UNHCR tent — but the empty pomp of a former house of power.",
    f01_l: '"— INSTRUMENTAL —"',
